...
//
//	mockgen -source=position_decoder.go -destination=vehicle_chooser_mock_test.go -package=positiondecoder
//

// Package positiondecoder is a generated GoMock package.
