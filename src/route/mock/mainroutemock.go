...
// Source: src/route/mainroute.go
//
// Generated by this command:
//
//	mockgen -source=src/route/mainroute.go -destination=src/route/mock/mainroutemock.go
//
...
func (m *MockIMainRoute) First() route.IMainStop {
	m.ctrl.T.Helper()
